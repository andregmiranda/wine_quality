...
ggplot(data = wq, aes(x = fixed.acidity)) +
  ...
  labs(title = 'Concentração de acidez fixa',
       x = 'Acidez fixa (g/L)', y = 'Ocorrências')
...
ggplot(data = wq, aes(x = volatile.acidity)) + 
  ...
  labs(title = 'Concentração de acidez volátil',
       x = 'Acidez volátil (g/L)', y = 'Ocorrências')
...
ggplot(data = wq, aes(x = citric.acid)) +
  geom_histogram(binwidth = 0.01) +
  labs(title = 'Concentração de ácido cítrico',
       x = 'Ácido cítrico (g/L)', y = 'Ocorrências')
...
p1 <- ggplot(data = wq, aes(x = residual.sugar)) +
  geom_histogram(binwidth = 0.1) +
  labs(title = 'Concentração de açúcar residual',
       x = 'Açúcar residual (g/L)', y = 'Ocorrências')
...
ggplot(data = wq, aes(x = chlorides)) +
  ...
  labs(title = 'Concentração de cloreto de sódio',
       x = 'Cloreto de sódio (g/L)', y = 'Ocorrências')
...
ggplot(data = wq, aes(x = free.sulfur.dioxide)) +
  ...
  labs(title = 'Concentração de dióxido de enxofre livre',
       x = 'Dióxido de enxofre livre (g/L)', y = 'Ocorrências')
...
ggplot(data = wq, aes(x = total.sulfur.dioxide)) +
  geom_histogram(binwidth = 0.005) +
  labs(title = 'Concentração de dióxido de enxofre total',
       x = 'Dióxido de enxofre total (g/L)', y = 'Ocorrências')
...
ggplot(data = wq, aes(x = density)) +
  ...
  labs(title = 'Distribuição da densidade',
       x = 'Densidade (g/L)', y = 'Ocorrências')
...
ggplot(data = wq, aes(x = sulphates)) +
  geom_histogram(binwidth = 0.01) +
  labs(title = 'Concentração de sulfato de potássio',
       x = 'Sulfato de potássio (g/L)', y = 'Ocorrências')
...
ggplot(data = wq, aes(x = alcohol)) +
  geom_histogram(binwidth = 0.1) +
  labs(title = 'Distribuição do teor alcóolico',
       x = 'Teor alcóolico (% do volume)', y = 'Ocorrências')
...
ggplot(data = wq, aes(x = alcohol, y = quality)) +
  ...
  labs(title = 'Qualidade x teor alcóolico',
       x = 'Teor alcóolico (% do volume)', y = 'Qualidade')
...
ggplot(data = wq, aes(x = chlorides, y = quality)) +
  ...
  geom_line(stat = "summary", fun.y = mean, color = "red") +
  geom_smooth() +
  labs(title = 'Qualidade x cloreto de sódio',
       x = 'Cloreto de sódio (g/L)', y = 'Qualidade')
...
ggplot(data = wq, aes(x = volatile.acidity, y = quality)) +
  ...
  geom_line(stat = "summary", fun.y = mean, color = "red") +
  geom_smooth() +
  labs(title = 'Qualidade x acidez volátil',
...
ggplot(data = wq, aes(x = alcohol, y = density)) +
  ...
  geom_line(stat = "summary", fun.y = mean, color = "red") +
  geom_smooth() +
  labs(title = 'Densidade x teor alcóolico',
       x = 'Teor alcóolico (% do volume)', y = 'Densidade (g/L)')
...
ggplot(data = wq, aes(x = residual.sugar, y = density)) +
  ...
  geom_line(stat = "summary", fun.y = mean, color = "red") +
  geom_smooth() +
  labs(title = 'Densidade x açúcar residual',
       x = 'Açúcar residual (g/L)', y = 'Densidade (g/L)')
...
ggplot(data = wq, aes(x = residual.sugar, y = alcohol)) +
  ...
  geom_line(stat = "summary", fun.y = mean, color = "red") +
  geom_smooth() +
  labs(title = 'Teor alcóolico x açúcar residual',
       x = 'Açúcar residual (g/L)', y = 'Teor alcóolico (% do volume)')
...
ggplot(data = wq, aes(x = fixed.acidity, y = volatile.acidity)) +
  ...
  geom_line(stat = "summary", fun.y = mean, color = "red") +
  geom_smooth() +
  labs(title = 'Acidez volátil x acidez fixa',
       x = 'Acidez fixa (g/L)', y = 'Acidez volátil (g/L)')
...
ggplot(data = wq, aes(x = sulphates, y = total.sulfur.dioxide)) +
  ...
  geom_line(stat = "summary", fun.y = mean, color = "red") +
  geom_smooth() +
  labs(title = 'Dióxido de enxofre total x sulfato de potássio',
       x = 'Sulfato de potássio (g/L)', y = 'Dióxido de enxofre (g/L)')
...
ggplot(data = wq, aes(x = classification, fill = quality.factor)) +
  ...
  labs(title = 'Qualidade x classificação',
       x = 'Classificação', y = 'Ocorrências')
...
ggplot(data = wq, aes(x = residual.sugar, y = quality)) +
  ...
  geom_line(stat = "summary", fun.y = mean, color = "red") +
  geom_smooth() +
  labs(title = 'Qualidade x açúcar residual',
       x = 'Açúcar residual (g/L)', y = 'Qualidade')
...
ggplot(data = wq, aes(x = check.count, fill = quality.factor)) +
  ...
  labs(title = 'Qualidade x testes aprovados',
       x = 'Testes aprovados', y = 'Ocorrências')
  ...
  scale_color_brewer(type = 'seq', direction = -1,
                     guide = guide_legend(title = 'Qualidade',
                                          override.aes = list(alpha = 1,
                                                              size = 2))) +
  labs(title = 'Qualidade x Teor alcóolico x Acidez volátil',
       x = 'Acidez volátil (g/L)', y = 'Teor alcóolico (% do volume)')
```
...
ggplot(data = wq, aes(x = volatile.acidity, y = quality)) +
  ...
  scale_color_manual(guide = guide_legend(title = 'Teor alcóolico'),
...
ggplot(data = wq, aes(x = citric.acid, y = sulphates)) +
  ...
  scale_color_brewer(type = 'seq', direction = -1,
                     guide = guide_legend(title = 'Qualidade',
                                          override.aes = list(alpha = 1,
                                                              size = 2))) +
  labs(title = 'Qualidade x ácido cítrico x sulfato de potássio',
       x = 'Ácido cítrico (g/L)', y = 'Sulfato de potássio (g/L)')
```
...
ggplot(data = wq, aes(x = fixed.acidity, y = volatile.acidity)) +
  ...
  scale_color_brewer(type = 'seq', direction = -1,
                     guide = guide_legend(title = 'Qualidade',
                                          override.aes = list(alpha = 1,
                                                              size = 2))) +
  labs(title = 'Qualidade x acidez volátil x acidez fixa',
       x = 'Acidez fixa (g/L)', y = 'Acidez volátil (g/L)')
```
...
ggplot(data = wq, aes(x = residual.sugar, y = alcohol)) +
  ...
  labs(title = 'Densidade x teor alcóolico x açúcar residual',
       x = 'Açúcar residual (g/L)', y = 'Teor alcóolico (% do volume)')
```
...
ggplot(data = subset(wq, classification != 'doce'),
  ...
  geom_boxplot() +
  labs(title = 'Proporção de dióxido de enxofre livre x classificação',
       x = 'Classificação', y = 'Proporção de dióxido de enxofre livre')
```
